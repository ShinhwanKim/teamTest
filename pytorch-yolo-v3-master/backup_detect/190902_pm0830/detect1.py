...
def arg_parse():
    ...
    parser.add_argument("--images", dest = 'images', help = 
                        ...
                        default = "asdf/180index76.jpg", type = str)
...
if __name__ ==  '__main__':
    ...
    #        print(end - start)
        ...
        def write(x, batches, results):
            ...
            img=int(x[0])
            cls = int(x[-1])
            if (str(format(classes[cls]))=='chair' or str(format(classes[cls]))=='person') and c1[1]>=650:
        ...
        #     # cv2.line(img,(0,600),(3000,600),[0,255,255],20)
        #
        ...
        for i,v in enumerate(person):
            ...
            for i, re in enumerate(result):
                ...
                if ((int(re[1]) <= int(center_x) and int(center_x) <= int(re[3])) and int(Right_y2) >= int(re[4])):
                    cv2.putText(img, "True", (center_x+10, center_y+50), cv2.FONT_HERSHEY_PLAIN, 3, [225, 255, 255], 3)
        ...
        cv2.imwrite(os.path.join("","190902/1125am/default3.jpg"), img)
