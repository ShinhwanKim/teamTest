...
def arg_parse():
    ...
    "Image / Directory containing images to perform detection upon",
                        default="asdf/90index50.jpg", type=str)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        def write(x, batches, results):
            ...
            if (str(format(classes[cls])) == 'chair' or str(format(classes[cls])) == 'person') and c1[1]>=350 and c1[1]<=1200:
        ...
        for i, v in enumerate(chair):
            ...
            # print(str(Right_y2)+"ㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ")
            # cv2.line(img,(0,600),(2000,580),[0,255,0],10)
        ...
        for i, v in enumerate(person):
            ...
            # cv2.line(img, (0, 50), (1800, 80), [0, 255, 0], 10)
        ...
        cv2.imwrite(os.path.join("", "190902/1125am/default2.jpg"), img)
